					...
					<div class="container h-full">
						<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
							<div class="layer-slick1 animated visible-false" data-appear="fadeInDown" data-delay="0">
								<span style="background-color: rgba(185, 185, 185, 0.5);border-radius: 5px;" class="ltext-101 cl2 respon2">
									<?= $arrSlider[$i]['descripcion'] ?>
								</span>
							</div>
								
							<div class="slider-nombre layer-slick1 animated visible-false" data-appear="fadeInUp" data-delay="800">
								<h2 style="background-color: rgba(185, 185, 185, 0.5);border-radius: 5px; margin-top: 30px; margin-bottom: 20px;" class="ltext-201 cl2 p-t-19 p-b-43 respon1">
									<?= $arrSlider[$i]['nombre'] ?>
								</h2>
							</div>
